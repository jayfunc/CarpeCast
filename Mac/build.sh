...
swiftc -O \
    ...
    "$SRC_DIR"/ContentView.swift "$SRC_DIR"/MediaManager.swift "$SRC_DIR"/NetworkManager.swift "$SRC_DIR"/UDPSocket.swift "$SRC_DIR"/PlayerView.swift "$SRC_DIR"/FileLogger.swift "$BUILD_DIR"/BuildInfo.swift \
